...
class Query {
  ...
  withConverter(converter) {
    ...
    next._startCursor = this._startCursor
      ? Object.assign({}, this._startCursor)
      : null;
    next._endCursor = this._endCursor
      ? Object.assign({}, this._endCursor)
      : null;
    ...
    return [...records].sort((left, right) => {
      for (const sort of this.sortItems) {
        const diff = this.compareValues(
          left === null || left === void 0 ? void 0 : left[sort.field],
          right === null || right === void 0 ? void 0 : right[sort.field],
        );
        if (diff !== 0) {
        ...
        { lastTxid: this.lastTxid },
        {
          onData: (event) => {
            ...
            if (changed) {
              ...
              callback(
                Object.assign(Object.assign({}, event), { record: this.cache }),
              );
            }
          },
          onError: (err) => {
            console.error(
              `Subscription error for query ${this.tableName}:`,
              err,
            );
          },
        },
  ...
  get() {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const normalizedRows = this._limitToLast
        ? rowModels.reverse()
        : rowModels;
